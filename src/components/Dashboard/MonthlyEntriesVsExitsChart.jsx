    ...
    return (
      <div className="flex justify-center items-center gap-4 -mt-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-gray-700">Entradas</span>
          <span className="text-xs font-semibold text-gray-900">Q{totalEntradas.toLocaleString()}</span>
        </div>
        ...
        {/* Salidas */}
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-0.5 bg-[#10b981] rounded"></div>
          <span className="text-xs text-gray-700">Salidas</span>
          <span className="text-xs font-semibold text-gray-900">Q{totalSalidas.toLocaleString()}</span>
        </div>
      </div>
    );
  };
