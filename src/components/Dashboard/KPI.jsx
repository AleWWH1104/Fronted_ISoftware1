...
const KPICards = () => {
  const kpiData = [
    ...
    },
    {
      ...
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="10" stroke="#046BB1" strokeWidth="2" />
          <path d="M12 6V12L16 14" stroke="#046BB1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="12" cy="12" r="10" stroke="#046BB1" strokeWidth="2" />
          <path d="M9 12L11 14L15 10" stroke="#046BB1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            strokeWidth="2"
          />
          <circle cx="9" cy="7" r="4" stroke="#046BB1" strokeWidth="2" />
          <path
